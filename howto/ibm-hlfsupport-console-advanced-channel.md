...
Documentation for this on-prem product has been moved from IBM Cloud to IBM Documentation at [https://www.ibm.com/docs/en/SSGWM34_1.0.0/howto/ibm-hlfsupport-console-advanced-channel.html](https://www.ibm.com/docs/en/SSGWM34_1.0.0/howto/ibm-hlfsupport-console-advanced-channel.html){: external}. Update your bookmarks.
{: important}
...
If your console is at a build before `2.1.3-104`, you will not see the **ordering service administrator** option. To see the version of your build, click on the support icon in the upper right corner (it resembles a question mark). The version will be listed below **{{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric version** on the upper left.
{: tip}
