...
* This tutorial requires use of the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric console. Therefore, after you deploy the platform, ensure that you can successfully log in to the console.
...
You have gathered your certificates and built your MSP. Before you can deploy a peer or ordering node, you need to import the MSP JSON file into your {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric console.
