...
|----|----|----|----|
| [{{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric](/docs/hlf-support?topic=hlf-support-whats-new#whats-new-05-03-2022) | 03 May 2022 | **Console and tools** <ul><li>1.0.3-20220503</li><li>1.0.0-20210915-amd64</li></ul> **Fabric nodes** <ul><li>2.2.3-20220601</li><li>2.2.3-20210915</li></ul> **CouchDB** <ul><li>2.2.3-20220601</li> <li>2.2.3-20210915</li></ul> | **Fabric Version Upgrade** <ul><li>Fabric version 2.2.3</li></ul> **Improvements to the Console UI** <ul><li>Support for Fabric v2.2.3 Lifecycle.</li></ul> |
| [{{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric](/docs/hlf-support?topic=hlf-support-whats-new#whats-new-03-29-2021) | 15 Sep 2021| **Console and tools** <ul><li>1.0.0-20220622</li><li>1.0.0-20210915-amd64</li></ul> **Fabric nodes** <ul><li>2.2.3-20220601</li><li>2.2.3-20210915</li></ul> **CouchDB** <ul><li>2.2.3-20220601</li> <li>2.2.3-20210915</li></ul> | **Fabric Version Upgrade** <ul><li>Fabric version 2.2.3</li></ul> **Improvements to the Console UI** <ul><li>Support for Fabric v2.2.3 Lifecycle.</li></ul> |
...
- [Upgrade to {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric](#upgrade-ocp-steps-100)


Or, if you are upgrading from behind a firewall
- [Upgrade to {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric](#upgrade-ocp-firewall)

After you upgrade the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric operator, the operator will automatically upgrade the console that is deployed on your OpenShift project. You can then use the upgraded console to upgrade your blockchain nodes.
...
If your {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric is running on OpenShift Container Platform 3.11, you cannot upgrade to {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric unless you first upgrade your OpenShift cluster from 3.11 to 4.7. For more information, see [Upgrading your migrationn](https://docs.openshift.com/container-platform/4.7/migration-toolkit-for-containers/installing-mtc.html).


## Upgrade to the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric
{: #upgrade-ocp-steps-100}
...
{: #upgrade-ocp-steps-100-operator}

Before updating the operator image, you need to stop the ibm-hlfsupport-console by running the following command. Replace <PROJECT_NAME> with the name of your project:
```
kubectl patch ibpconsole ibm-hlfsupport-console -n <PROJECT_NAME> -p='[{"op": "replace", "path":"/spec/replicas", "value":0}]' --type=json
```
{: codeblock}
...
```
kubectl set image deploy/ibm-hlfsupport-operator -n <PROJECT_NAME> ibm-hlfsupport-operator="cp.icr.io/cp/ibm-hlfsupport-operator:1.0.0-20220622-amd64"
```
{: codeblock}
...
Run the command `kubectl get deployment ibm-hlfsupport-operator -o yaml` command to confirm that the command updated the operator spec.
...
```
kubectl patch ibpconsole ibm-hlfsupport-console -n <PROJECT_NAME> -p='[{"op": "replace", "path":"/spec/replicas", "value":1}]' --type=json
```
{: codeblock}

### Step six: Upgrade your nodes

You can now follow the [steps](#upgrade-ocp-nodes) to upgrade your blockchain nodes. Be aware that after the nodes are upgraded, there is no way to roll back the upgrade from 1.0.0. After you upgrade to 1.0.0, you can take advantage of the new Fabric v2.x Lifecycle deployment process for your  smart contracts. But to avoid your peers crashing, you need to ensure that you upgrade your peers before you upgrade your channels. Learn more about considerations when [Upgrading to a new version of Fabric](/docs/hlf-support?topic=hlf-support-ibm-hlfsupport-console-govern-components#ibm-hlfsupport-console-govern-components-upgrade).
...
To upgrade your network, you need to [retrieve your entitlement key](/docs/hlf-support?topic=hlf-support-deploy-ocp#deploy-ocp-entitlement-key) from the My {{site.data.keyword.IBM_notm}} Dashboard, and you should have already [created a Kubernetes secret](/docs/hlf-support?topic=hlf-support-deploy-ocp#deploy-ocp-docker-registry-secret) to store the key on your OpenShift project. If the Entitlement key secret was removed from your cluster, or if your key is expired, then you need to download another key and create a new secret.  
...
You can upgrade the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric operator by fetching the operator deployment spec from your OpenShift project. When the operator upgrade is complete, the operator will upgrade your console and download the latest images for your blockchain nodes.

Log in to your cluster by using the OpenShift CLI. Because each {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric network runs in a different project, you must switch to each OpenShift project and upgrade each network separately. Go to the OpenShift project of the network that you want to upgrade. Replace `<PROJECT_NAME>` with the name of your project.
```
...
```yaml
cp.icr.io/cp/ibm-hlfsupport-operator:1.0.0-20220622-amd64
```
{: codeblock}
...
To upgrade your network, you need to [retrieve your entitlement key](/docs/hlf-support?topic=hlf-support-deploy-ocp-firewall#deploy-ocp-entitlement-key-firewall) from the My {{site.data.keyword.IBM_notm}} Dashboard, and [create a Kubernetes secret](/docs/hlf-support?topic=hlf-support-deploy-ocp#deploy-ocp-docker-registry-secret) to store the key on your OpenShift project. If the Entitlement key secret was removed from your cluster, or if your key is expired, then you need to download another key and create a new secret.
...
```
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-operator:2.5.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-operator:2.5.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-init:2.5.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-init:2.5.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-console:2.5.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-console:2.5.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-grpcweb:2.5.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-grpcweb:2.5.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-deployer:2.5.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-deployer:2.5.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-fluentd:2.5.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-fluentd:2.5.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-couchdb:2.3.1-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-couchdb:2.3.1-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport- docker://<LOCAL_REGISTRY>/ibm-hlfsupport- -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-peer:1.4.12-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-peer:1.4.12-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-orderer:1.4.12-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-orderer:1.4.12-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-ca:1.5.2-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-ca:1.5.2-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-dind:1.4.12-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-dind:1.4.12-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-utilities:1.4.12-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-utilities:1.4.12-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-peer:2.2.5-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-peer:2.2.5-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-orderer:2.2.5-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-orderer:2.2.5-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-chaincode-launcher:2.2.5-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-chaincode-launcher:2.2.5-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-utilities:2.2.5-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-utilities:2.2.5-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-ccenv:2.2.5-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-ccenv:2.2.5-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-goenv:2.2.5-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-goenv:2.2.5-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-nodeenv:2.2.5-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-nodeenv:2.2.5-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-javaenv:2.2.5-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-javaenv:2.2.5-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-peer:2.4.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-peer:2.4.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-orderer:2.4.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-orderer:2.4.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-chaincode-launcher:2.4.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-chaincode-launcher:2.4.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-utilities:2.4.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-utilities:2.4.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-ccenv:2.4.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-ccenv:2.4.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-goenv:2.4.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-goenv:2.4.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-nodeenv:2.4.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-nodeenv:2.4.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-javaenv:2.4.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-javaenv:2.4.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-crdwebhook:2.5.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-crdwebhook:2.5.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-ccenv:1.4.12-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-ccenv:1.4.12-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-goenv:1.4.12-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-goenv:1.4.12-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-nodeenv:1.4.12-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-nodeenv:1.4.12-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-javaenv:1.4.12-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-javaenv:1.4.12-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-enroller:2.5.3-20220622 docker://<LOCAL_REGISTRY>/ibm-hlfsupport-enroller:2.5.3-20220622 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
```
{: codeblock}
...
After you save and edit the file, run the following commands. Replace `<PROJECT_NAME>` with the name of your {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric deployment project.
```
...
You can upgrade the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric operator by fetching the operator deployment spec from your OpenShift project. You can then update the spec with the latest operator image that you pushed to your local registry. When the operator upgrade is complete, the operator will download the images that you pushed to your local registry and upgrade your console.
...
To upgrade a node, open the node tile and click the **Upgrade available** button. You cannot upgrade nodes that you imported to the console. Learn more about considerations when [Upgrading to a new version of Fabric](/docs/hlf-support?topic=hlf-support-ibm-hlfsupport-console-govern-components#ibm-hlfsupport-console-govern-components-upgrade).
