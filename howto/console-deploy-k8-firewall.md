...
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-ca:1.5.2-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-ca:1.5.2-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: ibm-hlfsupport-operator
          image: cp.icr.io/cp/ibm-hlfsupport-operator:1.0.0-20220111-amd64
          command:
            - ibp-operator
          imagePullPolicy: Always
          securityContext:
