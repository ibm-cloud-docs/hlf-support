...
3. Complete steps a-d to install the operator:  
   ...
   ![Selected clusters](../images/install-operator-5.png "Selected clusters"){: caption="Figure 5. Selected clusters" caption-side="bottom"}
   ...
   ![Selected namespace scope](../images/install-operator-3.png "Selected namespace scope"){: caption="Figure 3. Selected namespace scope" caption-side="bottom"}
