...
Documentation for this on-prem product has been moved from IBM Cloud to IBM Documentation at [https://www.ibm.com/docs/en/SSGWM34_1.0.0/howto/console-deploy-ocp-rhm.html](https://www.ibm.com/docs/en/SSGWM34_1.0.0/howto/console-deploy-ocp-rhm.html){: external}. Update your bookmarks.
{: important}
...
3. Complete steps a-d to install the operator:  
   ...
   ![Selected clusters](../images/install-operator-5.png "Selected clusters"){: caption="Figure 3. Selected clusters" caption-side="bottom"}
   ...
   ![Selected namespace scope](../images/install-operator-3.png "Selected namespace scope"){: caption="Figure 5. Selected namespace scope" caption-side="bottom"}
   ...
   ![Operator installed](../images/install-operator-7.png "Operator installed"){: caption="Figure 7. Operator installed" caption-side="bottom"}

If your OpenShift cluster is behind a firewall, see [Deploy from Red Hat Marketplace (airgap installation)](/docs/hlf-support?topic=hlf-support-deploy-ocp-rhm-fw).
