...
Documentation for this on-prem product has been moved from IBM Cloud to IBM Documentation at [https://www.ibm.com/docs/en/SSGWM34_1.0.0/howto/ansible-install-ibm-hlfsupport.html](https://www.ibm.com/docs/en/SSGWM34_1.0.0/howto/ansible-install-ibm-hlfsupport.html){: external}. Update your bookmarks.
{: important}
