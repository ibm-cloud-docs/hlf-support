...
services:
  peer-base:
    image: cp.icr.io/cp/ibm-hlfsupport-peer:2.2.3-20211026-amd64
    environment:
      - LICENSE=accept
      - FABRIC_CFG_PATH=/etc/hyperledger/fabric
      - CORE_CHAINCODE_BUILDER=cp.icr.io/cp/ibm-hlfsupport-ccenv:2.2.3-20211026-amd64
      - CORE_CHAINCODE_GOLANG_RUNTIME=cp.icr.io/cp/ibm-hlfsupport-goenv:2.2.3-20211026-amd64
      - CORE_CHAINCODE_NODE_RUNTIME=cp.icr.io/cp/ibm-hlfsupport-nodeenv:2.2.3-20211026-amd64
      - CORE_CHAINCODE_GOLANG_DYNAMICLINK=true
...
services:
  ...
  ca-org1:
    image: cp.icr.io/cp/ibm-hlfsupport-ca:2.2.3-20211026-amd64
    environment:
      - LICENSE=accept
