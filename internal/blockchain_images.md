...
For experienced Hyperledger Fabric customers, the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric provides images for peer, CA, ordering service, and smart contract containers that are signed and supported by {{site.data.keyword.IBM_notm}}. These images are the commercial distribution of Hyperledger Fabric v2.x.
{: shortdesc}
...
The {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric images must be deployed using a container environment on x86_64 or s390x hardware. Refer to the list of [Supported Platforms](/docs/hlf-support?topic=hlf-support-console-ocp-about#console-ocp-about-prerequisites).

Although you can deploy the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric images on Mac OS for testing purposes, the permissions on Mac OS might prevent you from instantiating a smart contract.
{: note}
...
## Downloading the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric images
...
```
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-operator:1.0.0-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-operator:1.0.0-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-init:1.0.0-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-init:1.0.0-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-console:1.0.0-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-console:1.0.0-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-grpcweb:1.0.0-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-grpcweb:1.0.0-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-deployer:1.0.0-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-deployer:1.0.0-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-fluentd:1.0.0-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-fluentd:1.0.0-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-couchdb:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-couchdb:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-couchdb:3.1.1-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-couchdb:3.1.1-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-peer:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-peer:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-orderer:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-orderer:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-ca:1.5.1-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-ca:1.5.1-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-dind:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-dind:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-utilities:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-utilities:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-peer:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-peer:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-orderer:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-orderer:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-chaincode-launcher:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-chaincode-launcher:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-utilities:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-utilities:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-ccenv:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-ccenv:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-goenv:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-goenv:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-nodeenv:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-nodeenv:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-javaenv:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-javaenv:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-crdwebhook:1.0.0-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-crdwebhook:1.0.0-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-ccenv:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-ccenv:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-goenv:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-goenv:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-nodeenv:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-nodeenv:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-javaenv:2.2.3-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-javaenv:2.2.3-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibm-hlfsupport-enroller:1.0.0-20220111 docker://cp.icr.io/cp/ibm-hlfsupport-enroller:1.0.0-20220111 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
```
{: codeblock}
...
3. If you are deploying a peer node, you need to use the core chaincode variables to instruct the peer to build chaincode using the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric certified images. For example, if you are using Go chaincode, you need to set the following variables:
    ```
    CORE_CHAINCODE_NODE_RUNTIME=cp.icr.io/cp/ibm-hlfsupport-nodeenv:2.2.3-20220111-amd64
...
We can provide an example of the changes you need to make by updating the `first-network` sample to run the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric images instead of the community Docker images. The example is provided for context, and is not a template for deploying a production network.
...
To deploy an ordering node by using the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric image, change the `image` field to the tag of the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric image, `cp.icr.io/cp/ibm-hlfsupport-orderer:2.2.3-20220111-amd64`. Accept the license by adding the field of `LICENSE=accept`. You then need to add the `FABRIC_CFG_PATH` environment variable and set the path to the folder where you mount the configuration files. Set the `working_dir` variable to the same path. After your changes, the orderer section would look like the example below:

```yaml
orderer-base:
  image: cp.icr.io/cp/ibm-hlfsupport-orderer:2.2.3-20220111-amd64
  environment:
    - LICENSE=accept
...
services:
  peer-base:
    image: cp.icr.io/cp/ibm-hlfsupport-peer:2.2.3-20220111-amd64
    environment:
      - LICENSE=accept
      - FABRIC_CFG_PATH=/etc/hyperledger/fabric
      - CORE_CHAINCODE_BUILDER=cp.icr.io/cp/ibm-hlfsupport-ccenv:2.2.3-20220111-amd64
      - CORE_CHAINCODE_GOLANG_RUNTIME=cp.icr.io/cp/ibm-hlfsupport-goenv:2.2.3-20220111-amd64
      - CORE_CHAINCODE_NODE_RUNTIME=cp.icr.io/cp/ibm-hlfsupport-nodeenv:2.2.3-20220111-amd64
      - CORE_CHAINCODE_GOLANG_DYNAMICLINK=true
...
You can use the updates that are provided in this example to deploy the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric images in the environment of your choice. The Fabric samples that are published by the Hyperledger community are intended to be used only as examples. Do not use the samples as templates for deploying production networks.

### Deploying an {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric Certificate Authority
{: #blockchain-images-example-ca}

The `first-network` sample does not use Certificate Authorities to deploy the network. However, you can find a file below that you can use to deploy an {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric Certificate Authority using Docker Compose. If you want to deploy a CA as part of the example, you should use this file instead of editing the `docker-compose-ca.yaml` file in the `first-network` directory, which deploys a CA using existing crypto material. Save the following file as ``docker-compose-ibm-ca.yaml``:
...
services:
  ...
  ca-org1:
    image: cp.icr.io/cp/ibm-hlfsupport-ca:2.2.3-20220111-amd64
    environment:
      - LICENSE=accept
...
5. Change back into the main directory of the BYFN example and save the following Docker Compose file for the gRPC web proxy image as `docker-compose-proxy`:
    ...
    services:
      web_proxy.peer0.org1.example.com:
        ...
        image: cp.icr.io/cp/ibm-hlfsupport-grpcweb:1.0.0-20220111-amd64
        environment:
          - LICENSE=accept
...
You can upgrade your deployment to the latest version of the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric images. The latest images normally contain security or stability improvements, or use a higher version Hyperledger Fabric, allowing you to take advantage of the latest Fabric features. To upgrade your network, you need to back up the ledger and MSP data for each node and then manually upgrade the node binaries. For more information about upgrading a network that you deployed using the {{site.data.keyword.IBM_notm}} Support for Hyperledger Fabric images, see [Upgrading Your Network Components](https://hyperledger-fabric.readthedocs.io/en/release-2.2/upgrade.html){: external} in the Hyperledger Fabric documentation.
